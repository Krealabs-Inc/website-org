    ...
    <div className="relative mx-auto flex w-full max-w-7xl flex-col justify-between gap-y-6 border-y bg-[radial-gradient(35%_80%_at_25%_0%,--theme(--color-foreground/.08),transparent)] px-4 py-8">
      ...
      <div className="space-y-1">
        <h2 className="text-center font-bold text-2xl text-gray-900 dark:text-white">
          Donnez vie a vos idees digitales.
        </h2>
        <p className="text-center text-gray-600 dark:text-gray-400">
          Commencez votre projet des aujourd'hui. Estimation gratuite en 24h.
        </p>
      </div>

      <div className="flex items-center justify-center gap-2">
        <Button variant="outline">Voir nos tarifs</Button>
        <Button className="bg-[#A543F1] hover:bg-[#A543F1]/90">
          Demarrer un projet <ArrowRightIcon className="size-4 ml-1" />
        </Button>
      </div>
    </div>
  );
