            ...
            >
                <div
                    className={cn(
                        ...
                        gradient,
                        "backdrop-blur-[2px] border-2 border-gray-200/50 dark:border-white/[0.15]",
                        "shadow-[0_8px_32px_0_rgba(143,153,237,0.1)] dark:shadow-[0_8px_32px_0_rgba(255,255,255,0.1)]",
                        "after:absolute after:inset-0 after:rounded-full",
                        "after:bg-[radial-gradient(circle_at_50%_50%,rgba(143,153,237,0.15),transparent_70%)] dark:after:bg-[radial-gradient(circle_at_50%_50%,rgba(255,255,255,0.2),transparent_70%)]"
                    )}
                />
            </motion.div>
        </motion.div>
                ...
                <div className="max-w-3xl mx-auto text-center">
                    ...
                    >
                        <p className="text-base sm:text-lg md:text-xl text-gray-600 dark:text-white/40 mb-8 leading-relaxed font-light tracking-wide max-w-xl mx-auto px-4">
                            Agence web et mobile à Clermont-Ferrand spécialisée dans React, Next.js et React Native. Transformons ensemble vos idées en solutions digitales performantes.
                        </p>
                    </motion.div>
                </div>
            </div>
