...
const testimonials: Testimonial[] = [
  {
    id: 1,
    quote: "Krealabs a transforme notre vision en une application web performante. Leur expertise React et leur attention aux details sont exceptionnelles.",
    name: "Sophie Martin",
    position: "CEO",
    company: "TechStart Auvergne",
    avatar: "https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=400&h=400&fit=crop"
  },
  {
    id: 2,
    quote: "Une collaboration fluide du design a la mise en production. Notre site Next.js depasse toutes nos attentes en termes de performance.",
    name: "Thomas Dubois",
    position: "CTO",
  ...
  {
    id: 3,
    quote: "L'equipe a su comprendre nos besoins et livrer une application mobile React Native de qualite professionnelle dans les delais.",
    name: "Marie Leclerc",
    position: "Directrice Marketing",
    company: "Commerce Connect",
    avatar: "https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=400&h=400&fit=crop"
  },
  {
    id: 4,
    quote: "Un vrai partenaire technique. Ils ont optimise notre plateforme pour atteindre des scores Lighthouse parfaits. Impressionnant !",
    name: "Pierre Durand",
    position: "Fondateur",
  ...
  {
    id: 5,
    quote: "Expertise technique solide et excellente communication. Notre projet a ete livre avec une qualite de code irreprochable.",
    name: "Julie Renard",
...
const TestimonialSlider: React.FC = () => {
  ...
  return (
    <div className="px-4 py-8 sm:py-16 bg-white dark:bg-[#030303] overflow-hidden transition-colors">
                ...
                >
                  ...
                  >
                    ...
                    <div className="relative z-10 h-full flex flex-col">
                      ...
                      <div className="mt-auto pt-3 sm:pt-4 border-t border-gray-100 dark:border-white/[0.08]">
                        <div className="flex items-center">
                          ...
                          <div className="ml-3">
                            ...
                            <p className="text-gray-600 dark:text-gray-400 text-xs sm:text-sm">{testimonial.position} - {testimonial.company}</p>
                          </div>
                        </div>
                      </div>
                    </div>
